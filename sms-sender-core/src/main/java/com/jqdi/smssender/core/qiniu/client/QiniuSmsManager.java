package com.jqdi.smssender.core.qiniu.client;
...
/**
 * <pre>
 * 复制com.qiniu.sms.SmsManager的源码
 * 因为sendSingleMessage不提供signatureId传参，而官网API有该参数
 * </pre>
 */
public class QiniuSmsManager {
     ...
     * 发送短信
     *
     * @param signatureId 签名ID，如果模板是未绑定签名的，可以发送时指定签名ID，非必填
     ...
     * @throws QiniuException 异常
     */
    public Response sendSingleMessage(String signatureId, String templateId, String mobile, Map<String, String> parameters)
            throws QiniuException {
