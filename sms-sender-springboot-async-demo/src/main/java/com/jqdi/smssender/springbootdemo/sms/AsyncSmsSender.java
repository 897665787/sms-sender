...
import com.jqdi.smssender.springbootdemo.amqp.strategy.StrategyConstants;
...
import com.jqdi.smssender.springbootdemo.sms.dto.MobileTemplateParam;
...
public class AsyncSmsSender {
	...
	public void send(List<MobileTemplateParam> mobileTemplateParamList, SmsEnum.Type type, LocalDateTime planSendTime,
		...
		smsTask.setRemark("AsyncSmsSender-" + DateFormatUtils.format(new Date(), "yyMMddHHmmss"));
